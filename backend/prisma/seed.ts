...
const submissions = [
  { id: 'sub-a1-s1', studentId: 's-1', activityId: 'a-1', status: 'submitted', submittedAt: '2026-09-18T15:00:00.000Z' },
  { id: 'sub-a1-s2', studentId: 's-2', activityId: 'a-1', status: 'submitted', submittedAt: '2026-09-18T15:05:00.000Z' },
  { id: 'sub-a1-s3', studentId: 's-3', activityId: 'a-1', status: 'submitted', submittedAt: '2026-09-18T15:10:00.000Z' },
  { id: 'sub-a1-s4', studentId: 's-4', activityId: 'a-1', status: 'submitted', submittedAt: '2026-09-18T15:15:00.000Z' },
  { id: 'sub-a2-s1', studentId: 's-1', activityId: 'a-2', status: 'submitted', submittedAt: '2026-09-19T10:00:00.000Z' },
  { id: 'sub-a2-s2', studentId: 's-2', activityId: 'a-2', status: 'submitted', submittedAt: '2026-09-19T10:10:00.000Z' },
  { id: 'sub-a2-s3', studentId: 's-3', activityId: 'a-2', status: 'submitted', submittedAt: '2026-09-19T10:20:00.000Z' },
  { id: 'sub-a3-s2', studentId: 's-2', activityId: 'a-3', status: 'submitted', submittedAt: '2026-09-20T08:30:00.000Z' },
  { id: 'sub-a6-s1', studentId: 's-1', activityId: 'a-6', status: 'submitted', submittedAt: '2026-09-19T12:00:00.000Z' },
  { id: 'sub-a6-s2', studentId: 's-2', activityId: 'a-6', status: 'submitted', submittedAt: '2026-09-19T12:05:00.000Z' },
  { id: 'sub-a6-s3', studentId: 's-3', activityId: 'a-6', status: 'submitted', submittedAt: '2026-09-19T12:10:00.000Z' },
  { id: 'sub-a6-s4', studentId: 's-4', activityId: 'a-6', status: 'in_progress', submittedAt: null },
] as const
