...
const activities = [
  ...
  },
  {
    ...
    directions: 'Write a short program that accepts a player name and score, then prints a formatted leaderboard row. Run your code and submit when the output looks correct.',
    starterCode: '// Enter player info and print a leaderboard row\nconst playerName = "Alex";\nconst score = 1500;\n\n// TODO: format and print the leaderboard row\nconsole.log(`${playerName}: ${score}`);',
    expectedOutput: 'Alex: 1500',
    autograderEnabled: true,
    autograderReferenceSolution: 'const playerName = "Alex";\nconst score = 1500;\nconsole.log(`${playerName}: ${score}`);',
  ...
  },
  {
    ...
    directions: 'Write a profile card using semantic HTML tags (header, main, section, footer). Include your name, a short bio, and one skill. Run the preview and submit when you are happy with the result.',
    starterCode: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8" />\n  <title>Profile Card</title>\n  <style>\n    body { font-family: sans-serif; display: flex; justify-content: center; padding: 2rem; }\n    .card { border: 1px solid #ddd; border-radius: 8px; padding: 1.5rem; max-width: 320px; }\n  </style>\n</head>\n<body>\n  <div class="card">\n    <!-- TODO: add your profile content here -->\n    <h1>Your Name</h1>\n  </div>\n</body>\n</html>',
    expectedOutput: null,
    resourceUrl: null,
    visible: true,
    position: 0,
...
const submissions = [
  ...
  { id: 'sub-a2-s1', studentId: 's-1', activityId: 'a-2', status: 'submitted', submittedAt: '2026-09-19T10:00:00.000Z', content: { responseText: 'const playerName = "Alex";\nconst score = 1500;\nconsole.log(`${playerName}: ${score}`);' } },
  { id: 'sub-a2-s2', studentId: 's-2', activityId: 'a-2', status: 'submitted', submittedAt: '2026-09-19T10:10:00.000Z', content: { responseText: 'const name = "Alex";\nconst total = 1500;\nconsole.log(name + ": " + total);' } },
  { id: 'sub-a2-s3', studentId: 's-3', activityId: 'a-2', status: 'submitted', submittedAt: '2026-09-19T10:20:00.000Z', content: { responseText: 'const playerName = "Alex";\nconst score = 1500;\nconsole.log(score);' } },
...
const grades = [
  ...
  { studentId: 's-1', activityId: 'a-2', pointsEarned: 20, comment: 'Autograder: 100% match (2/2 checks passed). Teacher can override this score.', gradingSource: 'autograder', autograderResult: { score: 100, summary: '100% match (2/2 checks passed)', matchedChecks: 2, totalChecks: 2, codeMatch: { passed: true }, outputMatch: { passed: true, expectedOutput: 'Alex: 1500', actualOutput: 'Alex: 1500', status: 'Accepted' } }, gradedById: null, gradedAt: '2026-09-19T16:30:00.000Z' },
  ...
  { studentId: 's-2', activityId: 'a-2', pointsEarned: 18, comment: 'Good logic, small formatting issues.', gradingSource: 'manual', autograderResult: { score: 50, summary: 'partial match (1/2 checks passed)', matchedChecks: 1, totalChecks: 2, codeMatch: { passed: false }, outputMatch: { passed: true, expectedOutput: 'Alex: 1500', actualOutput: 'Alex: 1500', status: 'Accepted' } }, gradedById: 't-1', gradedAt: '2026-09-21T10:00:00.000Z' },
  ...
  { studentId: 's-3', activityId: 'a-2', pointsEarned: 0, comment: 'Autograder: complete mismatch (0/2 checks passed). Teacher can override this score.', gradingSource: 'autograder', autograderResult: { score: 0, summary: 'complete mismatch (0/2 checks passed)', matchedChecks: 0, totalChecks: 2, codeMatch: { passed: false }, outputMatch: { passed: false, expectedOutput: 'Alex: 1500', actualOutput: '1500', status: 'Accepted' } }, gradedById: null, gradedAt: '2026-09-21T10:10:00.000Z' },
